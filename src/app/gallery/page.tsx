        ...
        {savedItems.map((item) => (
          ...
          >
            <div className="h-64 bg-gray-100 w-full flex items-center justify-center overflow-hidden relative">
              {item.image_url ? (
                <img src={item.image_url} alt={item.prompt} className="object-contain h-full w-full group-hover:scale-105 transition-transform duration-300" style={{ filter: 'grayscale(100%)' }} />
              ) : (
